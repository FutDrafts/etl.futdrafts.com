...
class TopRedItem(TypedDict):
    player: SoccerPlayer
    statistics: List[StatisticsItem]

class TopRedResponse200(TypedDict):
    get: str
    parameters: dict
    errors: List
    results: int
    paging: Paging
    response: List[TopRedItem]

class TopRedResponse204(TypedDict):
    get: str
    parameters: List
    errors: ErrorReport
    results: int
...
class TopRedResponse499(TypedDict):
    message: str

class TopRedResponse500(TypedDict):
    message: str

TopRedResponse = Union[
    TopRedResponse200,
    TopRedResponse204,
    TopRedResponse499,
    TopRedResponse500
