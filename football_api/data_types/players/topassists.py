...
class PlayerTopAssistsItem(TypedDict):
    player: SoccerPlayer
    statistics: List[StatisticsItem]

class PlayerTopAssistsResponse200(TypedDict):
    get: str
    parameters: dict
    errors: List
    results: int
    paging: Paging
    response: List[PlayerTopAssistsItem]

class PlayerTopAssistsResponse204(TypedDict):
    get: str
    parameters: List
    errors: ErrorReport
    results: int
...
class PlayerTopAssistsResponse499(TypedDict):
    message: str

class PlayerTopAssistsResponse500(TypedDict):
    message: str

PlayerTopAssistsResponse = Union[
    PlayerTopAssistsResponse200,
    PlayerTopAssistsResponse204,
    PlayerTopAssistsResponse499,
    PlayerTopAssistsResponse500
]
